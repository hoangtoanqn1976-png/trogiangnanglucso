...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Toàn - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0946661928</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Toàn - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0946661928</div>", unsafe_allow_html=True)
